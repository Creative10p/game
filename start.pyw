...
def start_screen():
    ...
    string_rendered = font.render("Новая игра", 1, "black")
    screen.blit(string_rendered, (87, 80))
    string_rendered = font.render("Прогресс", 1, "black")
...
def action_on_the_first_screen(position):
    ...
    if 80 <= position[0] <= 300 and 80 <= position[1] <= 120:
        ...
        string_rendered = font.render("Игра с другом", 1, "black")
        screen.blit(string_rendered, (60, 40))
        string_rendered = font.render("Игра с легким ИИ", 1, "black")
        screen.blit(string_rendered, (35, 140))
        string_rendered = font.render("Игра со сложным ИИ", 1, "black")
